...
*Applies to: v6.346 (app version) at sw cache v6-392 / Phase 1 (module split, Capacitor, weekly scenarios, AWS delivery, CI/CD) complete. Node.js 22+ recommended (CI and devcontainer pin Node 22).*
