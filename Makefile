...
verify-pages: ## 静的ページ検証（classroom/slides/privacy/announce-cards の Console ゼロ＋構造）
...
classroom-pdf: ## 教員ガイド＋生徒ワークシートを dist/*.pdf に自動生成（classroom/worksheet × ja/en、A4・白地）
